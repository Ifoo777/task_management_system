					...
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							...
							<select name="type" id="type" class="custom-select custom-select-sm">
								<option value="4" <?php echo isset($type) && $type == 3 ? 'selected' : '' ?>>Child</option>
								<option value="3" <?php echo isset($type) && $type == 3 ? 'selected' : '' ?>>Sister</option>
								<option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>Brother</option>
